...
use App\Http\Requests\RefferalRedeemRequest;
...
{
    public function save(ReferralsRequest $request)
    {
    ...
    public function getById(ReferralsByIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
    ...
    public function update(ReferralsByIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
    ...
    public function delete(ReferralsByIdRequest $request)
    {
    //  $validator = Validator::make($request->all(), [
    //         'id' => 'required',
    //     ]);
    ...
    public function redeemReferral(RefferalRedeemRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        //     'code' => 'required'
