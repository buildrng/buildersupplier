...
use App\Http\Requests\ChatRoomsByIdRequest;
use App\Http\Requests\ChatRoomWithParticiantsRequest;

class ChatRoomsController extends Controller
{
    public function createChatRooms(ChatRoomsRequest $request){
    ...
    public function getChatRooms(ChatRoomWithParticiantsRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'uid' => 'required',
        //     'participants' => 'required',
        // ]);
    ...
    public function getChatListBUid(ChatRoomsByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
