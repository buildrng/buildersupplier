...
use App\Http\Requests\SettingsByIdRequest;
use App\Http\Requests\SettingsLanguageIdRequest;
use App\Http\Requests\SettingsLanguagesRequest;
...
class SettingsController extends Controller
{
    ...
    public function getById(SettingsByIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
    ...
    public function update(SettingsByIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
    ...
    public function delete(SettingsByIdRequest $request)
    {
    //  $validator = Validator::make($request->all(), [
    //         'id' => 'required',
    //     ]);
    ...
    public function getByLanguageId(SettingsLanguageIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        ...
        $matchThese = ['is_default'=>1,'status'=>1];
        $general = General::first();
        $language = Languages::find($request->settings_language_id);
        $appUpdates = Flush::where('key','app_updates')->first();
        $support = User::select('id','first_name','last_name')->where('type','admin')->first();
        $data = [
            'settings'=>$settings,
    ...
    public function getByLanguageIdWeb(SettingsLanguageIdRequest $request)
    {
        try {
            // $validator = Validator::make($request->all(), [
            //     'id' => 'required',
