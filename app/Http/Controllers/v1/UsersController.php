...
use App\Http\Requests\UsersByIdRequest;
...
class UsersController extends Controller
{
    ...
    public function update(UsersByIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
    ...
    public function delete(UsersByIdRequest $request)
    {
    //  $validator = Validator::make($request->all(), [
    //         'id' => 'required',
    //     ]);
    ...
    public function sendMailToUsers(UserMailRequest $request)
    {
        try {
            // $validator = Validator::make($request->all(), [
            //     'subjects' => 'required',
            ...
            //     return response()->json($response, 404);
            // }
            $users = User::select('email','first_name','last_name')->where('type','customer')->get();
    ...
    public function sendMailToStores(UserMailRequest $request)
    {
        try {
            // $validator = Validator::make($request->all(), [
            //     'subjects' => 'required',
    ...
    public function sendMailToAll(UserMailRequest $request)
    {
        // Drivers
        try {
            // $validator = Validator::make($request->all(), [
    ...
    public function sendMailToDrivers(UserMailRequest $request)
    {
        try {
            // $validator = Validator::make($request->all(), [
            //     'subjects' => 'required',
    ...
    public function getInfo(UsersByIdRequest $request)
    {
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
