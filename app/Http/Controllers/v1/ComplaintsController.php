...
use App\Http\Requests\ComplaintsByIdRequest;

class ComplaintsController extends Controller
{
    public function save(ComplaintsRequest $request){
    ...
    public function getById(ComplaintsByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function update(ComplaintsByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function delete(ComplaintsByIdRequest $request){
    //  $validator = Validator::make($request->all(), [
    //         'id' => 'required',
    //     ]);
    //     if ($validator->fails()) {
    ...
    public function replyContactForm(MailRequest $request){
