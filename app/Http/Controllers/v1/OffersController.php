...
use App\Http\Requests\OffersByIdRequest;

class OffersController extends Controller
{
    public function save(OffersRequest $request){
    ...
    public function getById(OffersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function update(OffersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function updateStatus(OffersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function delete(OffersByIdRequest $request){
    //  $validator = Validator::make($request->all(), [
    //         'id' => 'required',
    //     ]);
    //     if ($validator->fails()) {
