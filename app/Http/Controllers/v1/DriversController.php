...
use App\Http\Requests\CitiesByIdRequest;
use App\Http\Requests\DriversByIdRequest;
...
class DriversController extends Controller
{
    ...
    public function getById(DriversByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function update(DriversByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function delete(DriversByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function geyByCity(CitiesByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
