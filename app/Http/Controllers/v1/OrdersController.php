...
use App\Http\Requests\OrdersByIdRequest;
use App\Http\Requests\OrdersByUidRequest;
use App\Http\Requests\OrderByStatusRequest;
use App\Http\Requests\OrdersByStoreRequest;
use App\Http\Requests\OrdersByDriverRequest;
use App\Http\Requests\OrdersStatsRequest;
...
{
    public function save(OrdersRequest $request){
    ...
    public function getById(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function getByIdFromStore(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function getByIdFromDriver(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function updateStatusStore(OrderByStatusRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        //     'notes' => 'required',
        //     'status' => 'required',
    ...
    public function update(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function delete(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function getByUid(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        //     'limit' => 'required',
        // ]);
        ...
        //     return response()->json($response, 404);
        // }
        $data = Orders::where('uid',$request->uid)->limit($request->limit)->orderBy('id','desc')->get();
        $response = [
            'data'=>$data,
            'success' => true,
            'status' => 200,
    ...
    public function getByStoreForApps(OrdersByStoreRequest $request){
        // $valaidator = Validator::make($request->all(), [
        //     'id' => 'required',
        //     'limit' => 'required',
        // ]);
        // if ($validator->fails()) {
        ...
        $data = Orders::where($request->store_id,'store_id')->orderBy('id','desc')->get();
    ...
    public function getByDriverIdForApp(OrdersByDriverRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'driver_id' => 'required',
        //     'limit' => 'required',
        // ]);
        ...
        $data = Orders::where($request->driver_id,'driver_id')->orderBy('id','desc')->get();
    ...
    public function getByOrderId(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function printStoreInvoice(OrdersByStoreRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id'     => 'required',
        //     'token'  => 'required',
        //     'store_id'  => 'required',
        ...
        try {
            ...
            foreach($data->orders as $loop){
                if($loop->store_id == $request->store_id){
            ...
            foreach($orderArray as $element){
                $dummyPrice = 0;
                if (isset($element->variations) && $element->variations && $element->variations !== '' && gettype($element->variations) == 'string') {
                ...
                if ($element && $element->discount == 0) {
                    if ($element->size == 1) {
                        if (isset($element->variations) && $element->variations[0]->items[$element->variant]->discount && $element->variations[0]->items[$element->variant]->discount !== 0) {
                            $dummyPrice = $dummyPrice + ((float)($element->variations[0]->items[$element->variant]->discount) * $element->quantity);
                        } else {
                            $dummyPrice = $dummyPrice + ((float)($element->variations[0]->items[$element->variant]->price) * $element->quantity);
                        }
                    } else {
                            $dummyPrice = $dummyPrice + ((float)($element->original_price) * $element->quantity);
                    }
                } else {
                    if ($element->size == 1) {
                        if (isset($element->variations) && $element->variations[0]->items[$element->variant]->discount && $element->variations[0]->items[$element->variant]->discount !== 0) {
                        ...
                        $dummyPrice = $dummyPrice + ((float)($element->sell_price) * $element->quantity);
                    }
                }
            ...
            $storeName = Stores::select('name')->where('uid',$request->store_id)->first();
            try {
            $storeExtra = array();
    ...
    public function getStoreStatsDataWithDates(OrdersStatsRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id'     => 'required',
        //     'from'     => 'required',
        //     'to'     => 'required',
    ...
    public function getByIdAdmin(OrdersByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
