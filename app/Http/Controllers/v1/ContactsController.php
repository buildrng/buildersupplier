...
use App\Http\Requests\ContactsByIdRequest;
...
class ContactsController extends Controller
{
    ...
    public function getById(ContactsByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function update(ContactsByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function delete(ContactsByIdRequest $request){
    //  $validator = Validator::make($request->all(), [
    //         'id' => 'required',
    //     ]);
    //     if ($validator->fails()) {
    ...
    public function sendMailToAdmin(MailRequest $request){
