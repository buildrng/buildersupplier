...
use App\Http\Requests\DriversRequiredAcceptedRequest;
use App\Http\Requests\DriversRequiredAcceptedThankyouResponseRequest;
use App\Http\Requests\DriversRequiredByIdRequest;
use App\Http\Requests\DriversRequiredDeclinedRequest;
use App\Http\Requests\DriversRequiredRequest;
...
{
    public function save(DriversRequiredRequest $request){
    ...
    public function getById(DriversRequiredByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function update(DriversRequiredByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function delete(DriversRequiredByIdRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        // ]);
        // if ($validator->fails()) {
    ...
    public function rejectRequest(DriversRequiredDeclinedRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        //     'subject' => 'required',
        //     'status' => 'required',
    ...
    public function acceptRequest(DriversRequiredAcceptedRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'id' => 'required',
        //     'subject' => 'required',
        //     'status' => 'required',
    ...
    public function thankyouReply(DriversRequiredAcceptedThankyouResponseRequest $request){
        // $validator = Validator::make($request->all(), [
        //     'email' => 'required',
        //     'subject' => 'required',
        // ]);
