  ...
  return (
    <div class={class}>
      ...
      {error ? (
        ...
        <div class="grid grid-cols-1 2xl:grid-cols-2 gap-3 md:gap-6 lg:gap-5 xl:gap-7">
          {variant === 'reverse' ? (
            <BannerCard
              banner={banner[1]}
          ...
          <div
            class={`grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-3 md:gap-5 xl:gap-7 ${
