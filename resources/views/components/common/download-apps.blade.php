...
const DownloadApps: React.FC<Props> = ({ class }) => {
			...
			<div class="flex-shrink-0 w-full sm:w-60 md:w-96 lg:w-auto lg:max-w-lg xl:max-w-xl lg:flex lg:items-center pb-5 md:pb-8 lg:pb-12 xl:pb-16">
				<div class="py-4 md:py-6 xl:py-8 text-center sm:text-start">
					<Text
						...
						class="-mt-1 mb-2 md:mb-3 lg:mb-3.5 xl:mb-4"
					>
						{t(`${title}`)}
					</Text>
					<h2
						class="text-heading text-md sm:text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-normal leading-7 sm:leading-8 md:leading-snug xl:leading-relaxed 2xl:leading-snug mb-6 md:mb-8 lg:mb-9 xl:mb-12 2xl:mb-14 lg:pe-20 2xl:pe-0"
