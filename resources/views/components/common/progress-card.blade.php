	...
	return (
		<div>
			<div class="flex justify-between items-center mb-2.5 md:mb-3 xl:mb-2.5 2xl:mb-4">
				<div class="text-body text-xs md:text-sm leading-6 md:leading-7">
					{t("text-sold")} :&nbsp;
					<span class="text-heading">{soldProduct}</span>
				</div>
				<div class="text-body text-xs md:text-sm leading-6 md:leading-7">
					{t("text-available")} :&nbsp;
					<span class="text-heading">{totalProduct - soldProduct}</span>
				</div>
			</div>
			<div class="relative w-full h-2.5 lg:h-3 2xl:h-4 bg-gray-100 rounded-full overflow-hidden">
				<div
					class="absolute h-full bg-heading"
