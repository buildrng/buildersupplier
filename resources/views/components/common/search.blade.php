			...
			>
				<div class="w-full flex flex-col justify-center">
					<div class="flex-shrink-0 mt-3.5 lg:mt-4 w-full">
						...
						{searchText && (
							<div class="bg-white flex flex-col rounded-md overflow-hidden h-full max-h-64vh lg:max-h-[550px]">
								<Scrollbar class="os-host-flexbox">
									<div class="h-full">
										{isLoading ? (
											<div class="p-5 border-b border-gray-300 border-opacity-30 last:border-b-0">
											...
											data?.map((item, index) => (
												<div
													class=" p-5 border-b border-gray-150 relative last:border-b-0"
													onClick={closeSearch}
												>
