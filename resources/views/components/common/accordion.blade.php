	...
	return (
		...
		>
			...
			>
				...
				<div class="flex-shrink-0 relative w-4 h-4 flex justify-center items-center">
					<div class="w-full h-0.5 bg-heading rounded-sm" />
					<div
						class={`origin-bottom transform w-0.5 h-full bg-heading rounded-sm absolute bottom-0 transition-transform duration-500 ease-in-out ${
			...
			<AnimatePresence initial={false}>
				{isOpen && (
					...
					>
						<div
							class={cn("pb-6 md:pb-7 leading-7 text-sm text-gray-600", {
