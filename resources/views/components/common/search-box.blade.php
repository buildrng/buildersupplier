...
const SearchBox = React.forwardRef<HTMLInputElement, SearchProps>(
	({ class, onSubmit, onClear, ...rest }, ref) => {
		...
		return (
			...
			>
				...
				<button
					type="button"
					class="outline-none text-2xl md:text-3xl text-gray-400 absolute top-0 end-0 w-12 md:w-14 h-full flex items-center justify-center transition duration-200 ease-in-out hover:text-heading focus:outline-none"
					onClick={onClear}
				>
