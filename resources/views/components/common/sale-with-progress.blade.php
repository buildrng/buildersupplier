...
const SellWithProgress: React.FC<Props> = ({
	...
	return (
		<div
			class={`flex flex-col border border-gray-300 rounded-lg pt-6 sm:pt-7 lg:pt-8 xl:pt-7 2xl:pt-9 px-4 md:px-5 lg:px-7 pb-6 lg:pb-7 ${
				productVariant !== "gridSlim" && "xl:px-5 2xl:px-7"
			} ${class}`}
		>
			<SectionHeader
				sectionHeading="text-flash-sale"
				class="mb-4 md:mb-5 lg:mb-6 xl:mb-5 2xl:mb-6 3xl:mb-8"
			/>
