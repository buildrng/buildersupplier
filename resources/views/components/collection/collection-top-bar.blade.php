...
const CollectionTopBar = () => {
	...
	return (
		<div class="flex justify-between items-center mb-7">
			<Text
				variant="pageHeading"
				class="hidden lg:inline-flex pb-1 capitalize"
			>
				{collectionTitle}
			</Text>
			<button
				...
				onClick={openFilter}
			>
				<MdCollectionsBookmark class="text-lg" />
				<span class="ps-2">{t("text-filters")}</span>
			</button>
			<div class="flex items-center justify-end">
				<div class="flex-shrink-0 text-body text-xs md:text-sm leading-4">
					9,608 {t("text-items")}
				</div>
			</div>
			<Drawer
