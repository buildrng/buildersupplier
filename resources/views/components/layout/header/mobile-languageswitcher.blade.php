<div class="relative ms-2 lg:ms-0 z-10 w-[140px] sm:w-[150px] lg:w-[130px] xl:w-[150px]">
    <button class="border border-gray-300 text-heading text-[13px] xl:text-sm font-semibold relative w-full py-2 ps-3 pe-7 text-start bg-white rounded-lg shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white focus-visible:ring-offset-orange-300 focus-visible:ring-offset-2 focus-visible:border-indigo-500 cursor-pointer"
        id="headlessui-listbox-button-:Rd2jm:" type="button" aria-haspopup="true" aria-expanded="false"
        data-headlessui-state="">
        <span class="flex truncate items-center">
            <span class="me-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us" viewBox="0 0 640 480" width="20px" height="15px">
                    <g fill-rule="evenodd">
                        <g stroke-width="1pt">
                            <path fill="#bd3d44"
            ...
            <svg
                stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="w-5 h-5 text-gray-400" aria-hidden="true" height="1em" width="1em"
