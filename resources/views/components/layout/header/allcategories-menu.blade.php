            ...
            <li class="">
                ...
                <div lass="absolute flex bg-white categoryMegaMenu shadow-header w-[630px] xl:w-[1000px] 2xl:w-[1200px] start-full">
                            ...
                            <div class="grid grid-cols-5">
                                ...
                                <ul class="pt-6 even:bg-gray-150 pb-7 2xl:pb-8 2xl:pt-7">
                                    <li class="mb-1.5">
                                        <a
                                            class="block text-sm py-1.5 text-heading font-semibold px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=western-wear">Western Wear</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=dresses">Dresses</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=jumpsuits">Jumpsuits</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=tops-t-shirt">Tops, T-Shirts &amp;
                                            Shirts</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=shorts-skirts">Shorts &amp; Skirts</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=shurgs">Shurgs</a>
                                        </li>
                                    <li class="border-b border-gray-300 pb-3.5 mb-3">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=blazers">Blazers</a>
                                        </li>
                                    <li class="mb-1.5">
                                        <a
                                            class="block text-sm py-1.5 text-heading font-semibold px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=plus-size">Plus Size</a>
                                        </li>
                                    <li class="mb-1.5">
                                        <a
                                            class="block text-sm py-1.5 text-heading font-semibold px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=sunglasses-frames">Sunglasses &amp;
                                            Frames</a>
                                        </li>
                                </ul>
                                <ul class="pt-6 even:bg-gray-150 pb-7 2xl:pb-8 2xl:pt-7">
                                    <li class="mb-1.5">
                                        <a
                                            class="block text-sm py-1.5 text-heading font-semibold px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=footwear">Footwear</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=flats">Flats</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=casual-shoes">Casual Shoes</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=heels">Heels</a>
                                        </li>
                                    <li class="border-b border-gray-300 pb-3.5 mb-3">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=boots">Boots</a>
                                        </li>
                                    <li class="mb-1.5">
                                        <a
                                            class="block text-sm py-1.5 text-heading font-semibold px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=sports-active-wear">Sports &amp; Active
                                            Wear</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=clothing">Clothing</a>
                                        </li>
                                    <li class="">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                    ...
                                    <li class="border-b border-gray-300 pb-3.5 mb-3">
                                        <a
                                            class="text-body text-sm block py-1.5 px-5 xl:px-8 2xl:px-10 hover:text-heading hover:bg-gray-300"
                                            href="/search?q=sports-accessories">Sports Accessories</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="hidden xl:block">
                        <div class="grid grid-cols-3 gap-3 p-6 2xl:py-8 2xl:px-7 3xl:grid-cols-3 justify-items-center">
                            <a class="bg-gray-200 border border-gray-300 rounded-md"
                                href="/search?q=nike">
                                <span
                                    ...
                                    <span
                                        ...
                                        <img
                                            ...
                                            src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%27150%27%20height=%2760%27/%3e">
                                        </span>
                                            <img
                                        alt="nike"
                                        ...
                                        <noscript>
                                            <img
                                            alt="nike"
                                            srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fnike.dfcdc145.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fnike.dfcdc145.png&amp;w=384&amp;q=75 2x"
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fnike.dfcdc145.png&amp;w=384&amp;q=75"
                                            decoding="async" data-nimg="intrinsic"
                                            style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                            loading="lazy" />
                                        </noscript>
                                        ...
                                        <a
                                class="bg-gray-200 border border-gray-300 rounded-md"
                                href="/search?q=dior">
                                <span
                                    style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
                                    <span
                                        ...
                                        <noscript>
                                            <img
                                            alt="dior"
                                            srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdior.3d290597.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdior.3d290597.png&amp;w=384&amp;q=75 2x"
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdior.3d290597.png&amp;w=384&amp;q=75"
                                            decoding="async" data-nimg="intrinsic"
                                            style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                            loading="lazy" />
                                        </noscript>
                                ...
                                <span
                                    ...
                                    <span
                                        ...
                                        <noscript>
                                            <img
                                            alt="gucci"
                                            srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgucci.8c86e519.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgucci.8c86e519.png&amp;w=384&amp;q=75 2x"
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgucci.8c86e519.png&amp;w=384&amp;q=75"
                                            decoding="async" data-nimg="intrinsic"
                                            style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                            loading="lazy" />
                                        </noscript>
                                ...
                                <span
                                    ...
                                    <span
                                        ...
                                        <noscript>
                                            <img
                                            alt="gucci1"
                                            srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgucci1.7fa72a7b.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgucci1.7fa72a7b.png&amp;w=384&amp;q=75 2x"
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fgucci1.7fa72a7b.png&amp;w=384&amp;q=75"
                                            decoding="async" data-nimg="intrinsic"
                                            style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                            loading="lazy" />
                                        </noscript>
                                ...
                                <span
                                    ...
                                    <span
                                        ...
                                        <noscript>
                                            <img
                                            alt="puma"
                                            srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpuma.17fd544e.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpuma.17fd544e.png&amp;w=384&amp;q=75 2x"
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpuma.17fd544e.png&amp;w=384&amp;q=75"
                                            decoding="async" data-nimg="intrinsic"
                                            style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                            loading="lazy" />
                                        </noscript>
                                ...
                                <span
                                    ...
                                    <span
                                        ...
                                        <noscript>
                                            <img
                                            alt="levis"
                                            srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flevis.35f00c22.png&amp;w=256&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flevis.35f00c22.png&amp;w=384&amp;q=75 2x"
                                            src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flevis.35f00c22.png&amp;w=384&amp;q=75"
                                            decoding="async" data-nimg="intrinsic"
                                            style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%"
                                            loading="lazy" />
                                        </noscript>
