<div class="mx-auto max-w-[1920px] px-4 md:px-8 2xl:px-16">
    ...
    <a class="transition-colors duration-200 hover:text-black" href="https://www.instagram.com/buildersuppler/">Instagram</a>
  </li>
  <li class="flex items-baseline">
  <span class="me-3 relative top-0.5 lg:top-1 text-sm lg:text-base">
  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
  ...
  <a class="transition-colors duration-200 hover:text-black" href="https://twitter.com/buildersuppler">Twitter</a>
</li>
  <li class="flex items-baseline">
  <span class="me-3 relative top-0.5 lg:top-1 text-sm lg:text-base">
  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
  ...
  <a class="transition-colors duration-200 hover:text-black" href="https://www.facebook.com/buildersuppler/">Facebook</a>
</li>
  <li class="flex items-baseline">
  <span class="me-3 relative top-0.5 lg:top-1 text-sm lg:text-base">
  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
  <path d="M508.64 148.79c0-45-33.1-81.2-74-81.2C379.24 65 322.74 64 265 64h-18c-57.6 0-114.2 1-169.6 3.6C36.6 67.6 3.5 104 3.5 149 1 184.59-.06 220.19 0 255.79q-.15 53.4 3.4 106.9c0 45 33.1 81.5 73.9 81.5 58.2 2.7 117.9 3.9 178.6 3.8q91.2.3 178.6-3.8c40.9 0 74-36.5 74-81.5 2.4-35.7 3.5-71.3 3.4-107q.34-53.4-3.26-106.9zM207 353.89v-196.5l145 98.2z">
      ...
      <div class="pb-3 md:pb-0 undefined">
        ...
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">yourexample@email.com</a>
      </li>
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">example@email.com</a>
      </li>
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">Call us: +1 254 568-5479</a>
      </li>
      </ul>
      </div>
      <div class="pb-3 md:pb-0 undefined">
        ...
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">Customer Support</a>
      </li>
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/contact-us">About Us</a>
      </li>
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">Copyright</a>
      </li>
      </ul>
      </div>
      <div class="pb-3 md:pb-0 undefined">
        ...
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">Shipping &amp; Delivery</a>
      </li>
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">Return &amp; Exchanges</a>
      </li>
      </ul>
      </div>
      <div class="pb-3 md:pb-0 undefined">
        ...
        <li class="flex items-baseline">
        <a class="transition-colors duration-200 hover:text-black" href="/">Site Map</a>
      </li>
      </ul>
      </div>
      <div class="pb-3 md:pb-0 undefined">
        ...
        <ul class="text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5">
          <template x-for="category in home.categorys">
            <li class="flex items-baseline">
              <a class="transition-colors duration-200 hover:text-black" :href="'/category/'+category.slug">
      ...
      <div class="border-t border-gray-300 pt-5 pb-16 sm:pb-20 md:pb-5 mb-2 sm:mb-0">
        ...
        <li class="mb-2 md:mb-0 transition hover:opacity-80">
        <a href="/" target="_blank">
        <img src="/assets/images/footer/payment/paypal.svg" alt="Paypal" width="76" height="20">
      </a>
      </li>
        <li class="mb-2 md:mb-0 transition hover:opacity-80">
        <a href="/" target="_blank">
