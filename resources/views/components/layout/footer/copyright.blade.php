...
const Copyright: React.FC<CopyrightProps> = ({ payment }) => {
	...
	return (
		<div class="border-t border-gray-300 pt-5 pb-16 sm:pb-20 md:pb-5 mb-2 sm:mb-0">
			<Container class="flex flex-col-reverse md:flex-row text-center md:justify-between">
				<p class="text-body text-xs lg:text-sm leading-6">
				...
				{payment && (
					<ul class="hidden md:flex flex-wrap justify-center items-center space-s-4 xs:space-s-5 lg:space-s-7 mb-1 md:mb-0 mx-auto md:mx-0">
						{payment?.map((item) => (
							<li
								class="mb-2 md:mb-0 transition hover:opacity-80"
