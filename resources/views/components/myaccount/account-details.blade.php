		...
		>
			...
			>
				<div class="flex flex-col space-y-4 sm:space-y-5">
					<div class="flex flex-col sm:flex-row sm:space-s-3 space-y-4 sm:space-y-0">
						<Input
					...
					<div class="relative flex flex-col">
						<span class="mt-2 text-sm text-heading font-semibold block pb-1">
							{t("common:text-gender")}
						</span>
						<div class="mt-2 flex items-center space-s-6">
							<RadioBox
					...
					<div class="relative">
						<Button
							...
							loading={isLoading}
							disabled={isLoading}
							class="h-12 mt-3 w-full sm:w-32"
						>
