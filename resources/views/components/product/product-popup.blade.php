		...
		<div class="rounded-lg bg-white">
			<div class="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
				...
				<div class="flex flex-col p-5 md:p-8 w-full">
					<div class="pb-5">
						<div
							class="mb-2 md:mb-2.5 block -mt-1.5"
					...
					<div class="pt-2 md:pt-4">
						<div class="flex items-center justify-between mb-4 space-s-3 sm:space-s-4">
							...
							<Button
								onClick={addToCart}
								variant="flat"
								class={`w-full h-11 md:h-12 px-1.5 ${
						...
						{viewCartBtn && (
							<button
								...
								class="w-full mb-4 h-11 md:h-12 rounded bg-gray-100 text-heading focus:outline-none border border-gray-300 transition-colors hover:bg-gray-50 focus:bg-gray-50"
							>
								{t("text-view-cart")}
							</button>
						)}
