<div class="!md:mb-14 !xl:mb-[60px] relative mx-auto mb-5 !mb-12 max-w-[1920px] md:mb-8">
	<div class="full pagination-left relative mx-0">
        ...
        {{-- <div class="absolute top-2/4 z-10 flex w-full items-center">
			<button class="duration-250 absolute flex hidden h-7 w-7 -translate-x-1/2 transform items-center justify-center rounded rounded-full bg-white text-sm text-black shadow-navigation transition start-6 hover:bg-gray-900 hover:text-white focus:outline-none md:text-base md:text-base md:start-8 lg:h-8 lg:h-9 lg:w-8 lg:w-9 lg:text-lg lg:text-xl xl:h-10 xl:w-10 xl:start-12 2xl:start-16 3xl:h-12 3xl:w-12 3xl:text-2xl" id="hero-slider-prev" aria-label="prev-button">
					<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    <path d="M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z">
                    </path>
                </svg>
			</button>
			<button class="duration-250 absolute flex hidden h-7 w-7 translate-x-1/2 transform items-center justify-center rounded rounded-full bg-white text-sm text-sm text-black shadow-navigation transition end-6 hover:bg-gray-900 hover:text-white focus:outline-none md:text-base md:text-base md:end-8 lg:h-8 lg:h-9 lg:w-8 lg:w-9 lg:text-lg lg:text-xl xl:h-10 xl:w-10 xl:end-12 2xl:end-16 3xl:h-12 3xl:w-12 3xl:text-2xl" id="hero-slider-next" aria-label="next-button">
					<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
