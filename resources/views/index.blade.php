<x-layout.layout>
    <x-slot:title>Home</x-slot>
        ...
        <div class="col-span-full lg:col-span-2">
            ...
            <div x-init="home = post('home/searchWithCity','id', 4, this.home)">
                        ...
                        <template x-for="banner in home.banners">
                            <a class="group relative flex justify-center" href="/">
                                ...
                                <span style="box-sizing:border-box;display:block;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;max-width:100%">
                                    <img :src="'/assets/images/'+banner.cover" alt="" style="display:block;max-width:100%;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0">
                                </span>
                            </a>
                        </template>
